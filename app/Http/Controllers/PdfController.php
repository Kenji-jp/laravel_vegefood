    ...
    public function convert_orders_data_to_html(){
        ...
        $output = '<link rel="stylesheet" href="frontend/css/style.css">
                        <table class="table">
                            <thead class="thead">
                                <tr class="text-left">
                                    <th>Client Name : '.$name.'<br> Client Address : '.$address.'</th>
                                </tr>
                            </thead>
                        </table>
                        <table class="table">
        ...
        foreach($orders as $order){
            foreach($order->cart->items as $item){
                ...
                $output .= '<tr class="text-center">
                                <td class="image-prod"><img src="storage/cover_images/'.$item['product_image'].'" alt="" style = "height: 80px; width: 80px;"></td>
