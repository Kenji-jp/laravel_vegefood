...
<section id="home-section" class="hero">
  ...
  <div class="slider-item" style="background-image: url(storage/cover_images/{{ $slider->slider_image }});">
  ...
  @endforeach
                ...
                <div class="col-md-6">
                  <div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(frontend/images/category-1.jpg);">
                    <div class="text px-3 py-1">
                      <h2 class="mb-0"><a href="{{ url('/select_product_by_category/Fruits')}}">Fruits</a></h2>
                    </div>
                  </div>
                  <div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url(frontend/images/category-2.jpg);">
                    <div class="text px-3 py-1">
                      <h2 class="mb-0"><a href="{{ url('/select_product_by_category/Vegetables')}}">Vegetables</a></h2>
                    </div>
                  </div>
                </div>
              </div>
					...
					<div class="col-md-4">
						<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(frontend/images/category-3.jpg);">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="{{ url('/select_product_by_category/Juices')}}">Juices</a></h2>
							</div>		
						</div>
						<div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url(frontend/images/category-4.jpg);">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="{{ url('/select_product_by_category/Dried')}}">Dried</a></h2>
							</div>
						</div>
					</div>
				</div>
    ...
    <section class="ftco-section">
		...
		<section class="ftco-section img" style="background-image: url(storage/cover_images/{{ $slider->slider_image }});">
    	<div class="container">
          ...
          <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate">
            ...
            <div id="timer" class="d-flex mt-5">
              ...
              <span class="price mt-3 mr-3">Sales period</span>
